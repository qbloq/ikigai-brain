...
Budget: [Score/100] - [Qualitative analysis].

Authority: [Score/100] - [Qualitative analysis].

Need: [Score/100] - [Qualitative analysis].

Timeline: [Score/100] - [Qualitative analysis].
...
Lead Archetype: [Name of Archetype] - [Description of the archetype].

Priority Classification: [HIGH/MEDIUM/LOW PRIORITY] - [Justification and recommended next step].
The types of lead archetypes are: Emotional trader, novice trader, or inexperienced person.
...

{
  ...
  "leadProfile": {
    ...
    "intelligentSegmentation": {
      "archetype": {
        "name": "string (Emotional trader, novice trader, inexperienced person)",
        "description": "string"
      },
